...
public interface HttpTestReqOrBuilder extends
   ...
   * <code>.Status status = 15;</code>
   */
  com.xxx.httptest.proto.Status getStatus();

  /**
   * <code>repeated .OrderItem items = 16;</code>
   */
  java.util.List<com.xxx.httptest.proto.OrderItem> 
      getItemsList();
  /**
   * <code>repeated .OrderItem items = 16;</code>
   */
  com.xxx.httptest.proto.OrderItem getItems(int index);
  /**
   * <code>repeated .OrderItem items = 16;</code>
   */
  int getItemsCount();
   ...
   * <code>repeated .OrderItem items = 16;</code>
   */
  java.util.List<? extends com.xxx.httptest.proto.OrderItemOrBuilder> 
      getItemsOrBuilderList();
  /**
   * <code>repeated .OrderItem items = 16;</code>
   */
  com.xxx.httptest.proto.OrderItemOrBuilder getItemsOrBuilder(
      int index);
