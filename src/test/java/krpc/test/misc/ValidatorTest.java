...
public class ValidatorTest {
    ...
    public void test1() throws Exception {
        ...
        String s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.userId", s);

        req = b.setUserId("1").build();
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s1", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s2", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.i1", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.i2", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.i4", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.i3", s);
        req = b.setI3(0).build();
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.i4", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateSub.s1", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s5", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s6", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.i5", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s7", s);
        req = b.addS7("123").build();
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s7", s);
        req = b.addS7("123").build();
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s31", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s32", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s33", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s34", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s35", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s36", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s37", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s38", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s39", s);
        ...
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.k", s);
        ...
        req = b.addK(bs.build()).build();
        s = v.validate(req);
        Assert.assertEquals("ValidateTestReq.s41", s);
