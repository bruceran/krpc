...
import krpc.KrpcExt;
import krpc.cluster.DefaultClusterManager;
...
import krpc.core.proto.RpcMetas;
import krpc.impl.DefaultDataManager;
import krpc.impl.DefaultExecutorManager;
import krpc.impl.DefaultMockService;
import krpc.impl.DefaultProxyGenerator;
import krpc.impl.RpcCallableBase;
...
import krpc.monitor.LogFormatter;
import krpc.monitor.DefaultMonitorService;
import krpc.registry.DefaultRegistryManager;
...
import krpc.web.impl.NettyHttpServer;
...
public class Bootstrap {
	...
	private RpcApp doBuild() {
		...
		app.traceIdGenerator = newTraceIdGenerator();
		...
		for (String name : clients.keySet()) {
			...
			client.setTraceIdGenerator(app.traceIdGenerator);
