...
public class DefaultProxyGenerator implements ProxyGenerator {
	...
	public Object generateReferer(Class<?> intf,RpcCallable callable) {
		try {
			...
			cls.addField(CtField.make("private krpc.core.RpcCallable client;", cls));
			cls.addConstructor(CtNewConstructor.make("public "+implSimpleName+"(krpc.core.RpcCallable client) {this.client = client;}", cls));
