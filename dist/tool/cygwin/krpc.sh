...
mkdir -p target/src  
./protoc-3.5.1.exe $1.proto --java_out=target/src --descriptor_set_out=$1.proto.pb
...
javac -encoding utf-8 -cp "protobuf-java-3.5.1.jar;krpc-0.1.0.jar;*;." -d target/classes/ target/src/$javapackagepath/*.java
